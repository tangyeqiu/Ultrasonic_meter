	...
	__CONFIG _DEBUG_OFF&_CP_ALL&_WRT_HALF&_CPD_ON&_LVP_OFF&_BODEN_OFF&_PWRTE_ON&_WDT_ON&_HS_OSC
;************************************
...
INT_Init
	...
	bsf OPTION_REG, 3 ;PSA prescaler to WDT
	bsf OPTION_REG, 2 ; rate 64
	bsf OPTION_REG, 1 ;
	bcf OPTION_REG, 0
	bcf INTCON, 0	;RBIF
	bsf INTCON, 3	;RBIE
